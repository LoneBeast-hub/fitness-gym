        ...
        <div className="container">
          <div className="footer-container">
            <div className="footer-item">
              <h2 className="heading__footer u-margin-bottom-small">
            ...
            <div className="footer-item">
              <h2 className="heading__footer u-margin-bottom-medium">
                visit the gym
              </h2>
              ...
              <p className="footer__paragraph acsd">
                Phone no.
              </p>
              <span className="footer__paragraph u-margin-bottom-small">07063278712</span>
              <span className="footer__paragraph acsd">
                Address:
              </span>
            ...
            <div className="footer-item">
              ...
              <div className="fa-icon">
                <Link to="https://www.facebook.com/share/ETqPvLiLRsigjarw/?mibextid=qi2Omg" target="_blank" rel="noreferrer">
                  <i className="fab fa-facebook social-icon" aria-hidden="true"></i>
                </Link>
                <Link to="https://x.com/goodnessgfc?t=zEKsEzlA_caXXCVt3c5Y1Q&s=09" target="_blank" rel="noreferrer">
                  <i className="fab fa-twitter social-icon" aria-hidden="true" rel="noreferrer"></i>
                </Link>
