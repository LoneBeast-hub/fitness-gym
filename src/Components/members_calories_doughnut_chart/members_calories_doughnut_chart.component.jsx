...
const MembersCaloriesDoughnutChart = () => {
    ...
    return(
        <div id="lodComponent" className="pt-[1.7rem] w-full md:max-w-[32%] border-[0.5px] border-gray-e5 pr-[0.9rem] pl-[1.2rem] pb-[1.3rem]">
            ...
            <div className="flex w-full h-[160px] items-center justify-center relative">
                <p className='text-center'>
                    <span className='text-[2.5rem] text-black-100 font-bold'>2140</span><br/>
                    <span className='text-[2rem] text-black-2'>kcal</span>
                </p>
                <Doughnut
            ...
            <div className='flex items-center justify-center gap-[1rem] mt-[3rem]'>
                ...
                <div className='flex gap-[0.5rem]'>
                    ...
                    {/* Percentage and name */}
                    <p className='text-black-100 text-[1.2rem]'><span className='text-[1.2rem]'>20</span>% Fat</p>
                </div>
            </div>
        </div>
    )
