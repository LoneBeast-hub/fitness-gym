...
const AdminLogin = () => {
    ...
    const onSubmit = async (data) => {
        try {
            const result = await fetch("https://goodnessgfc.com.ng/gymserver/admin/authenticate/login_user.php", {
                method: 'POST',
                body: JSON.stringify({
                'email': data.username,
            ...
            if (response.response === true) {
                ...
                if (response.userid === userProfileResponse.userprofile.userid) {
                    console.log("User ID matches. Redirecting to admin dashboard.");
                    // give user access to admin dashboard
